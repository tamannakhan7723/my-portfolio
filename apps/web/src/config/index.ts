...
import { LuGithub, LuPencil, LuLinkedin, LuRss, LuPalette, LuCode, LuBrain, LuRocket } from "react-icons/lu";
import { FaXTwitter,FaGamepad } from "react-icons/fa6";
import { FaReact, FaAws } from "react-icons/fa";
import { SiPhp, SiDart, SiLatex, SiTensorflow, SiPytorch, SiOpencv, SiScikitlearn, SiLangchain, SiFlutter, SiPandas, SiNumpy, SiJupyter, SiHtml5, SiCss, SiBootstrap, } from 'react-icons/si';
...
const config: Config = {
  ...
  author: "tamanna",
  keywords: ["TAMANNA KHAN", "tamannakhan", "Computer Engineer | Web Designer and Developer ", "Coder", "Portfolio"],
  status: " Computer Engineer | Web Designer and Developer⚡️",
  siteURL: "https://tamannak.netlify.app",
  openGraph: {
    url: "https://tamannak.netlify.app",
    type: "website",
  ...
  about: {
    ...
    "additionalName": "",
    "pronouns": 'She/Her',
    "githubUsername": "tamannakhan7723",
    "introduction": `
...
- Starting of Engineering and Programming Journey.
`        ,
        },
        {
